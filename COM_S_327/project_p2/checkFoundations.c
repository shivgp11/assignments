...
int checkFoundations(FILE* fp) {
	...
	if(strcmp(foundations, "FOUNDATIONS:") != 0) {
		printf("Expected 'FOUNDATIONS:' near line %d\n", line);
		return 0;
	}
	...
	fgets(clubs, 3, fp);
	if (clubs[1] != 'c'){
		printf("Expected clubs foundation' near line %d\n", line);
		return 0;
	}
	...
	if (clubs[0] != '_'){
		...
		if (found == 0) {
			printf("Invalid Rank near line %d\n", line);
			return 0;
		}
	}
	...
	fgets(diamonds, 3, fp);
	if (diamonds[1] != 'd'){
		printf("Expected 'diamonds foundation' near line %d\n", line);
		return 0;
	}
	...
	fgets(hearts, 3, fp);
	if (hearts[1] != 'h'){
		printf("Expected 'hearts foundation' near line %d\n", line);
		return 0;
	}
	...
	fgets(spades, 3, fp);
	if (spades[1] != 's'){
		printf("Expected 'spades foundation' near line %d\n", line);
		return 0;
	}
